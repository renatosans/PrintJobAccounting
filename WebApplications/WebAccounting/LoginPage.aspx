<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="WebAccounting.LoginPage" %>
        ...
        <form id="loginArea" runat="server">
            <asp:Table ID="loginBox" runat="server" CssClass="loginBoxStyle" Width="380px" Height="240px">
                ...
                <asp:TableRow ID="TableRow4" runat="server" HorizontalAlign="Center">
                    <asp:TableCell ID="TableCell4A" runat="server" ColumnSpan="2">
                        <button type="button" onclick="btnChangePasswordClick();" class="glyphButtonStyle" ><img src="images/ChangePassword.ico" /></button>
                        <asp:Label ID="lblChangePassword" runat="server" Text="Alterar senha" style="color:blue;font-weight:bold"/>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="TableRow5" runat="server" HorizontalAlign="Center">
                    <asp:TableCell ID="TableCell5A" runat="server" ColumnSpan="2"></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="TableRow6" runat="server" HorizontalAlign="Center">
                    <asp:TableCell ID="TableCell6A" runat="server" ColumnSpan="2"><asp:Button ID="btnLogin" runat="server" Text="Login" Width="120px" onclick="btnLogin_Click" /></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="TableRow7" runat="server" HorizontalAlign="Center">
                    <asp:TableCell ID="TableCell7A" runat="server" ColumnSpan="2"><asp:Label ID="lblErrorMessages" runat="server" Text="Mensagens de erro" CssClass="errorMessagesStyle" /></asp:TableCell>
                </asp:TableRow>
            </asp:Table>
        </form>
