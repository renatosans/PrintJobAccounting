<%@ Page Title="" Language="C#" MasterPageFile="~/AccountingMasterPage.master" AutoEventWireup="true" CodeBehind="UserPrintingCosts.aspx.cs" Inherits="WebAccounting.UserPrintingCosts" %>
...
<asp:Content ID="bodyContent" ContentPlaceHolderID="bodyPlaceHolder" Runat="Server">
    <asp:Panel ID="reportSurface" runat="server" HorizontalAlign="Center">
        <br/>
        <br/>
        <asp:Label ID="lblTitle" runat="server" Text="Relatório de custos de impressão por Usuário" CssClass="titleStyle"></asp:Label>
        <br/>
        <br/>
        ...
        <asp:Table ID="reportFilter" runat="server" CssClass="reportFilterStyle">
            <asp:TableRow ID="TableRow1" runat="server">
                <asp:TableCell ID="TableCell1A" runat="server"><asp:Label ID="lblUser" runat="server" Text="Usuário" Width="100px"></asp:Label></asp:TableCell>
