<%@ Page Title="" Language="C#" MasterPageFile="~/AccountingMasterPage.master" AutoEventWireup="true" CodeBehind="DevicePrintingCosts.aspx.cs" Inherits="WebAccounting.DevicePrintingCosts" %>
...
<asp:Content ID="bodyContent" ContentPlaceHolderID="bodyPlaceHolder" Runat="Server">
    <asp:Panel ID="reportSurface" runat="server" HorizontalAlign="Center">
        <br/>
        <br/>
        <asp:Label ID="lblTitle" runat="server" Text="Relatório de custos de impressão por Equipamento" CssClass="titleStyle"></asp:Label>
        <br/>
        <br/>
        ...
        <asp:Table ID="reportFilter" runat="server" CssClass="reportFilterStyle">
            <asp:TableRow ID="TableRow1" runat="server">
                <asp:TableCell ID="TableCell1A" runat="server"><asp:Label ID="lblPrinter" runat="server" Text="Impressora"  Width="100"></asp:Label></asp:TableCell>
