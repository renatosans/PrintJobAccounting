...
{
    public partial class GroupPrintingCosts : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack) // Ajusta os valores iniciais do filtro
            {
                ...
                ListItem[] costCenterList = DropDownScaffold.Retrieve("pr_retrieveCostCenter", sqlConnection, typeof(CostCenter));
                costCenterList[0].Text = "Todos os centros de custo";
                cmbCostCenter.Items.AddRange(costCenterList);
            ...
            try
            {
                costCenterId = DropDownScaffold.GetSelectedItemId(cmbCostCenter);
            ...
            {
                String queryString = "?costCenterId=" + costCenterId.ToString() + "&" +
                                     "startDate=" + startDate.ToString() + "&" +
                                     "endDate=" + endDate.ToString() + "&" +
                                     "detailType=PrintingCosts";

                Response.Redirect("GroupCostDetails.aspx" + queryString);
                return;
            }
        ...
        private void GenerateReport(DateTime startDate, DateTime endDate)
        {
            ...
            GroupPrintingCostsReport report = new GroupPrintingCostsReport(tenant.id, startDate, endDate);
