...
{
    public partial class DevicePrintingCosts : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack) // Ajusta os valores iniciais do filtro
            {
                ...
                printerList[0].Text = "Todas as impressoras";
        ...
        private void GenerateReport(DateTime startDate, DateTime endDate)
        {
            ...
            DevicePrintingCostsReport report = new DevicePrintingCostsReport(tenant.id, startDate, endDate);
