<%@ Page Title="" Language="C#" MasterPageFile="~/AccountingMasterPage.master" AutoEventWireup="true" CodeBehind="GroupPrintingCosts.aspx.cs" Inherits="WebAccounting.GroupPrintingCosts" %>
...
<asp:Content ID="bodyContent" ContentPlaceHolderID="bodyPlaceHolder" Runat="Server">
    <asp:Panel ID="reportSurface" runat="server" HorizontalAlign="Center">
        <br/>
        <br/>
        <asp:Label ID="lblTitle" runat="server" Text="Relatório de custos de impressão por Grupo (CC)" CssClass="titleStyle"></asp:Label>
        <br/>
        <br/>
        ...
        <asp:Table ID="reportFilter" runat="server" CssClass="reportFilterStyle">
            <asp:TableRow ID="TableRow1" runat="server">
                <asp:TableCell ID="TableCell1A" runat="server"><asp:Label ID="lblCostCenter" runat="server" Text="Centro de Custo" Width="110px"></asp:Label></asp:TableCell>
                <asp:TableCell ID="TableCell1B" runat="server" ColumnSpan="2"><asp:DropDownList ID="cmbCostCenter" runat="server" Width="200px"></asp:DropDownList></asp:TableCell>
            </asp:TableRow>
