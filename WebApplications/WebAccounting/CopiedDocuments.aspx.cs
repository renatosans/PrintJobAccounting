...
{
    public partial class CopiedDocuments : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            GenerateReport(startDate, endDate, userId, printerId);
        }
        ...
        private void GenerateReport(DateTime startDate, DateTime endDate, int? userId, int? printerId)
        {
            ...
            CopiedDocumentsReport report = new CopiedDocumentsReport(tenant.id, startDate, endDate, userId, printerId);
