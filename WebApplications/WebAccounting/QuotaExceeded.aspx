<%@ Page Title="" Language="C#" MasterPageFile="~/AccountingMasterPage.master" AutoEventWireup="true" CodeBehind="QuotaExceeded.aspx.cs" Inherits="WebAccounting.QuotaExceeded" %>
...
<asp:Content ID="bodyContent" ContentPlaceHolderID="bodyPlaceHolder" Runat="server">
    <asp:Panel ID="reportSurface" runat="server" HorizontalAlign="Center">
        <br/>
        <br/>
        <asp:Label ID="lblTitle" runat="server" Text="Relatório de Cotas Excedidas" CssClass="titleStyle"></asp:Label>
        <br/>
        <br/>
