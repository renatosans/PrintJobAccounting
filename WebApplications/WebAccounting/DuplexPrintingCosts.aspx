<%@ Page Title="" Language="C#" MasterPageFile="~/AccountingMasterPage.master" AutoEventWireup="true" CodeBehind="DuplexPrintingCosts.aspx.cs" Inherits="WebAccounting.DuplexPrintingCosts" %>
...
<asp:Content ID="bodyContent" ContentPlaceHolderID="bodyPlaceHolder" Runat="Server">
    <asp:Panel ID="reportSurface" runat="server" HorizontalAlign="Center">
        <br/>
        <br/>
        <asp:Label ID="lblTitle" runat="server" Text="Relatório de custos de impressão Simplex/Duplex" CssClass="titleStyle"></asp:Label>
        <br/>
        <br/>
        ...
        <asp:Table ID="reportFilter" runat="server" CssClass="reportFilterStyle">
            <asp:TableRow ID="TableRow1" runat="server">
                <asp:TableCell ID="TableCell1A" runat="server"><div style="width:100px"></div></asp:TableCell>
                <asp:TableCell ID="TableCell1B" runat="server" ColumnSpan="2"><div style="width:210px"></div></asp:TableCell>
            </asp:TableRow>
